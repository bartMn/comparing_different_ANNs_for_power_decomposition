...
csv_datapath =  os.path.abspath(os.getcwd()) +os.sep+ "results_100_100" +os.sep+  "place_1_20_20" +os.sep+ "predictions.csv"
...
plt.ylabel("real power [p.u.]")#plt.show(block=True)

plt.tight_layout()
path_to_save = os.path.abspath(os.getcwd()) +os.sep+ "plots" +os.sep+ f"real_decomposition_100_100.png"
...
#plt.show(block=True)
plt.tight_layout()
path_to_save = os.path.abspath(os.getcwd()) +os.sep+ "plots" +os.sep+ f"predicted_decomposition_100_100.png"
plt.savefig(path_to_save)
plt.close()