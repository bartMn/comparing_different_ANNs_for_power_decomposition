...
def main():
    ...
    graphs(100, new_path, loss_function)
           

def graphs(test_in_training_houses, path, loss_function):
    ...
    for layers in range(1, 4):
        for place in places:
            testing_houses = 20
            newpath = path + os.sep + f"results search for {test_in_training_houses}" + os.sep + f"place {place} in {layers}FNN_tr_20_te{test_in_training_houses}_adam"
            newpath = newpath + os.sep + f"tested on {testing_houses} houses"
            draw_graphs(datapath = newpath, testing_houses = testing_houses, anntype = "FFN", loss_function = loss_function)
...
#######################
    ...
    csv_datapath = csv_datapath +os.sep+ f"percentiles_all_FFNs_test_{testing_houses}.csv"
