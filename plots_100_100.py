...
def main():
    folders = ["results_100_100"]
    folder_num = 0
    new_path = PATH + os.sep + folders[folder_num]
    loss_function = folders[folder_num].split('_')[1]
    graphs(new_path, loss_function)
    #graphs(100, new_path, loss_function)
           

def graphs(path, loss_function):
   
   
    testing_houses = 100
    newpath = path + os.sep + "place_1_20_20"
    draw_graphs(datapath = newpath, testing_houses = testing_houses, anntype = "FFN", loss_function = loss_function)
    
    testing_houses = 100
    newpath = path + os.sep + "place_2_20_20"
    draw_graphs(datapath = newpath, testing_houses = testing_houses, anntype = "FFN", loss_function = loss_function)
    
    testing_houses = 100
    newpath = path + os.sep + "place_1_20_100"
    draw_graphs(datapath = newpath, testing_houses = testing_houses, anntype = "FFN", loss_function = loss_function)
    
    testing_houses = 100
    newpath = path + os.sep + "place_2_20_100"
    draw_graphs(datapath = newpath, testing_houses = testing_houses, anntype = "FFN", loss_function = loss_function)
...
#######################
    ...
    csv_datapath = csv_datapath +os.sep+ f"percentiles_100_100.csv"
