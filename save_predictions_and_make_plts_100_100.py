...
def main():
    ...
    testing_houses = 100
    newpath = path + os.sep + f"results_100_100" + os.sep + f"place_1_20_20"
    draw_graphs(datapath = newpath, testing_houses = testing_houses, anntype = "FFN", loss_function = "mse")
    
    testing_houses = 100
    newpath = path + os.sep + f"results_100_100" + os.sep + f"place_2_20_20"
    draw_graphs(datapath = newpath, testing_houses = testing_houses, anntype = "FFN", loss_function = "huber")
    
    testing_houses = 100
    newpath = path + os.sep + f"results_100_100" + os.sep + f"place_1_20_100"
    draw_graphs(datapath = newpath, testing_houses = testing_houses, anntype = "FFN", loss_function = "huber")
    
    testing_houses = 100
    newpath = path + os.sep + f"results_100_100" + os.sep + f"place_2_20_100"
    draw_graphs(datapath = newpath, testing_houses = testing_houses, anntype = "FFN", loss_function = "mape")    
...
#######################
    ...
    csv_datapath = csv_datapath +os.sep+ f"percentiles_all_FFNs_100_100.csv"
