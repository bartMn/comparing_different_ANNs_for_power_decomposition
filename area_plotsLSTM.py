...
csv_datapath =  os.path.abspath(os.getcwd()) +os.sep+ "results_LSTMs" +os.sep+  f"tested_on_{testing_houses}" +os.sep+ f"LSTM{Lnum}" +os.sep+ "predictions.csv"
...
#plt.show(block=True)
plt.tight_layout()
path_to_save = os.path.abspath(os.getcwd()) +os.sep+ "plots" +os.sep+ f"real_decomposition_LSTM_{testing_houses}.png"
...
#plt.show(block=True)
plt.tight_layout()
path_to_save = os.path.abspath(os.getcwd()) +os.sep+ "plots" +os.sep+ f"predicted_decomposition_LSTM_{testing_houses}.png"
plt.savefig(path_to_save)
plt.close()